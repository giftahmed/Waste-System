...
<p>
		<div id="box2">
			<p style="font-weight: 500px;">As previously observed within most organizations that deal with high income businesses most of its income generated from secondary material which is of less value,
	...
	<img src="images/login.png" width="230" height="150" alt="" title="Apply now" /></a></li>
				<li><a href="index.php?page=2"><img src="images/disposal1.jpg" width="230" height="150" alt="" title="Praesent scelerisque scelerisque erat" /></a></li>
				<li><a href="index.php"><img src="images/transport.jpg" width="230" height="150" alt="" title="Integer sit amet pede vel arcu aliquet pretium" /></a></li>
